//! K3 timer and watchdog registers.

use crate::register::RWNoModify;
use volatile_register::{RO, RW, WO};

// https://github.com/spacemit-com/docs-chip/blob/main/en/key_stone/k3/k3_docs/k3_usermanual/16_peripherals/timer_watchdog.md
// This chapter covers APB_TIMERS1/2, PMU_TIMERS and SEC_TIMERS; other instances need validation.
