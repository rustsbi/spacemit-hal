//! K3 camera capture and CSI PHY registers.

use crate::register::{RW1C, RWNoModify};
use volatile_register::{RO, RW};

// https://github.com/spacemit-com/linux-6.18/blob/4158237f35b8fd62ba198c1627e5a66e5a34c50f/drivers/media/platform/spacemit/cam_ccic/ccic_hwreg.h
// https://github.com/spacemit-com/linux-6.18/blob/4158237f35b8fd62ba198c1627e5a66e5a34c50f/drivers/media/platform/spacemit/cam_ccic/ccic_hwreg.c
...
pub struct RegisterBlock {
    ...
    /// REG_CSI2_VCCTRL2.
    pub csi2_vcctrl2: RW<u32>,
    /// REG_CSI2_DT_FLT.
    pub csi2_dt_flt: RW<u32>,
    /// REG_CSI2_DT_FLT2.
    pub csi2_dt_flt2: RW<u32>,
    /// REG_CSI2_DPHY1.
    ...
    _padding_0x314: [u32; 6],
    /// REG_CSI2_DPHY9.
    pub csi2_dphy9: RW<u32>,
...
mod tests {
    ...
    fn layout() {
        ...
        assert_eq!(offset_of!(RegisterBlock, csi2_vcctrl2), 0x118);
        assert_eq!(offset_of!(RegisterBlock, csi2_dt_flt), 0x11c);
        assert_eq!(offset_of!(RegisterBlock, csi2_dt_flt2), 0x120);
        ...
        assert_eq!(offset_of!(RegisterBlock, csi2_dphy9), 0x32c);
